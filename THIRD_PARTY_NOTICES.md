...
| --- | --- | --- |
| yt-dlp | Media extraction and download | [yt-dlp project](https://github.com/yt-dlp/yt-dlp) |
| FFmpeg / ffprobe | Merging, conversion, clipping, and validation | [FFmpeg legal information](https://ffmpeg.org/legal.html) |
| Deno | JavaScript runtime used by yt-dlp extractors | [Deno project](https://github.com/denoland/deno) |
| Adobe CSInterface | CEP panel-to-host bridge | [Adobe CEP resources](https://github.com/Adobe-CEP/CEP-Resources) |
